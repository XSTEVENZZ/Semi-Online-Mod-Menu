<?php
// Conexão
require_once '/storage/ssd4/290/15501290/public_html/DB.php';
...
if(isset($_POST['btn-entrar'])):
	...
	if(empty($login) or empty($senha)):
		...
		$sql = "SELECT login FROM usuariosx WHERE login = '$login'";
		$resultado = mysqli_query($conn, $sql);		

		if(mysqli_num_rows($resultado) > 0):
		$senha = md5($senha);       
		$sql = "SELECT * FROM usuariosx WHERE login = '$login' AND senha = '$senha'";
