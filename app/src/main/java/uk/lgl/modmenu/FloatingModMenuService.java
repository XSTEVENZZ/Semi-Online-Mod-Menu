...
public class FloatingModMenuService extends Service {
    ...
    private final String PASS = "VENDEDOR";
	...
	public String usuarioa = Prefs.with(this).read(USER);
	public String vendedora = Prefs.with(this).read(PASS);
    public String vala = Prefs.with(this).read(VAL);
	public String titlea = Prefs.with(this).read(TITLE);
	public String icona = Prefs.with(this).read(ICON);
	public String isactivea = Prefs.with(this).read(ISACTIVE);
	public String featurea = Prefs.with(this).read(FEATURE0);
	public String featureb = Prefs.with(this).read(FEATURE1);
	public String featurec = Prefs.with(this).read(FEATURE2);
	
	
	public String[] FeatureList = {featurea,
		featureb, featurec
	};
    ...
    private void initFloating() {
        ...
        byte[] decode = Base64.decode(icona, 0);
        ...
        textView2.setText(Html.fromHtml("<marquee><p style=\'color:green;\'>Vendedor: " + vendedora + "  |   Validade: " + vala +"     |  Usuario: " + usuarioa + "</p></p></marquee>"));
