    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            if(data.get("Status").toString().equals("Success")) {
               ...
               // .setMessage("ok");
					.setMessage(Html.fromHtml(" <font color='#ff0000'>Usuario: </font>" + data.get("Username").toString() + "<br><font color='#ff0000'>Data de Registro: </font>" + data.get("RegisterDate").toString() + "<br><font color='#ff0000'>Validade: </font>" + data.get("SubscriptionLeft").toString() + "<br><font color='#ff0000'>Status: </font><font color='#ff0000'>Ativo</font></font>"));
