...
JNICALL
Java_uk_lgl_modmenu_Auth_Title(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF("https:onlinemod/login.php");
}
extern "C" JNIEXPORT jstring
JNICALL
Java_uk_lgl_modmenu_Auth_CurrentStatusLib(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF("Ativo");
}
extern "C" JNIEXPORT jstring
JNICALL
Java_uk_lgl_modmenu_MainActivity_Dialog(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF("Mod Menu + Funcionamento Online\nMitos Team Inspiration :)");
}
extern "C" JNIEXPORT jstring
JNICALL
Java_uk_lgl_modmenu_MainActivity_TeamName(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF("Your Team");
}
extern "C" JNIEXPORT jstring
JNICALL
Java_uk_lgl_modmenu_MainActivity_URL(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF("youtube.com/c/s4muu");
}
